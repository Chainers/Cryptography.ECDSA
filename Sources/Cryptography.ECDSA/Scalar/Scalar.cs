...
namespace Cryptography.ECDSA
{
    internal partial class Scalar
    {
        ...
        /// <param name="r"></param>
        /// <param name="x"></param>
        public static void secp256k1_scalar_inverse(secp256k1_scalar r, secp256k1_scalar x)
        {
            ...
            *r = 0;
            ...
            u2 = new secp256k1_scalar();
            secp256k1_scalar_sqr(u2, x);
            x2 = new secp256k1_scalar();
            secp256k1_scalar_mul(x2, u2, x);
            u5 = new secp256k1_scalar();
            secp256k1_scalar_mul(u5, u2, x2);
            x3 = new secp256k1_scalar();
            secp256k1_scalar_mul(x3, u5, u2);
            u9 = new secp256k1_scalar();
            secp256k1_scalar_mul(u9, x3, u2);
            u11 = new secp256k1_scalar();
            secp256k1_scalar_mul(u11, u9, u2);
            u13 = new secp256k1_scalar();
            secp256k1_scalar_mul(u13, u11, u2);

            x6 = new secp256k1_scalar();
            secp256k1_scalar_sqr(x6, u13);
            secp256k1_scalar_sqr(x6, x6);
            secp256k1_scalar_mul(x6, x6, u11);

            x8 = new secp256k1_scalar();
            secp256k1_scalar_sqr(x8, x6);
            secp256k1_scalar_sqr(x8, x8);
            secp256k1_scalar_mul(x8, x8, x2);

            x14 = new secp256k1_scalar();
        ...
        public static bool secp256k1_scalar_is_even(secp256k1_scalar a)
        {
            return (a.d[0] & 1) < 1;
        }
#endif
