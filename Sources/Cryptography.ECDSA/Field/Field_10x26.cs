...
namespace Cryptography.ECDSA
{
    ...
    internal class secp256k1_fe
    {
        ...
        public secp256k1_fe(UInt32[] arr)
        {
            n = arr;
        }

        public secp256k1_fe(secp256k1_fe other)
        {
            n = new uint[other.n.Length];
            Array.Copy(other.n, n, other.n.Length);
        }

        public secp256k1_fe Clone()
        {
            return new secp256k1_fe(this);
        }
    ...
    internal class secp256k1_fe_storage
    {
        public UInt32[] n;

        public secp256k1_fe_storage()
        {
            n = new UInt32[8];
        }

        public secp256k1_fe_storage(UInt32[] arr)
        {
            n = arr;
        }

        public secp256k1_fe_storage(secp256k1_fe_storage other)
        {
            n = new uint[other.n.Length];
            Array.Copy(other.n, n, other.n.Length);
        }

        public secp256k1_fe_storage Clone()
        {
            return new secp256k1_fe_storage(this);
        }
    }
    ...
    internal partial class Field
    {
        ...
        public static void secp256k1_fe_normalize(secp256k1_fe r)
        {
        ...
        public static void secp256k1_fe_normalize_weak(secp256k1_fe r)
        {
            UInt32 t0 = r.n[0], t1 = r.n[1], t2 = r.n[2], t3 = r.n[3], t4 = r.n[4],
                t5 = r.n[5], t6 = r.n[6], t7 = r.n[7], t8 = r.n[8], t9 = r.n[9];
        ...
        public static void secp256k1_fe_normalize_var(secp256k1_fe r)
        {
            UInt32 t0 = r.n[0], t1 = r.n[1], t2 = r.n[2], t3 = r.n[3], t4 = r.n[4],
                t5 = r.n[5], t6 = r.n[6], t7 = r.n[7], t8 = r.n[8], t9 = r.n[9];
        ...
        public static bool secp256k1_fe_normalizes_to_zero(secp256k1_fe r)
        {
            UInt32 t0 = r.n[0], t1 = r.n[1], t2 = r.n[2], t3 = r.n[3], t4 = r.n[4],
                t5 = r.n[5], t6 = r.n[6], t7 = r.n[7], t8 = r.n[8], t9 = r.n[9];
        ...
        public static bool secp256k1_fe_normalizes_to_zero_var(secp256k1_fe r)
        {
        ...
        public static void secp256k1_fe_set_int(secp256k1_fe r, UInt32 a)
        {
            r.n[0] = a;
        ...
        public static bool secp256k1_fe_is_zero(secp256k1_fe a)
        {
            var t = a.n;
#if VERIFY
        ...
        public static bool secp256k1_fe_is_odd(secp256k1_fe a)
        {
#if VERIFY
                    Util.VERIFY_CHECK(a.normalized);
                    secp256k1_fe_verify(a);
        ...
        public static void secp256k1_fe_clear(secp256k1_fe a)
        {
            int i;
#if VERIFY
                    a.magnitude = 0;
        ...
        public static bool secp256k1_fe_set_b32(secp256k1_fe r, byte[] a)
        {
        ...
        /// <param name="r"></param>
        /// <param name="a"></param>
        public static void secp256k1_fe_get_b32(byte[] r, secp256k1_fe a)
        {
#if VERIFY
                    Util.VERIFY_CHECK(a.normalized);
                    secp256k1_fe_verify(a);
        ...
        public static void secp256k1_fe_negate(secp256k1_fe r, secp256k1_fe a, UInt32 m)
        {
#if VERIFY
        ...
        public static void secp256k1_fe_mul_int(secp256k1_fe r, UInt32 a)
        {
            r.n[0] *= a;
            r.n[1] *= a;
            r.n[2] *= a;
        ...
        public static void secp256k1_fe_add(secp256k1_fe r, secp256k1_fe a)
        {
#if VERIFY
                    secp256k1_fe_verify(a);
#endif
        ...
        public static void secp256k1_fe_mul_inner(UInt32[] r, UInt32[] a, UInt32[] b)
        {
            UInt64 c, d;
        ...
        public static void secp256k1_fe_sqr_inner(UInt32[] r, UInt32[] a)
        {
            UInt64 c, d;
            UInt64 u0, u1, u2, u3, u4, u5, u6, u7, u8;
        ...
        public static void secp256k1_fe_mul(secp256k1_fe r, secp256k1_fe a, secp256k1_fe b)
        {
#if VERIFY
        ...
        public static void secp256k1_fe_sqr(secp256k1_fe r, secp256k1_fe a)
        {
#if VERIFY
            Util.VERIFY_CHECK(a.magnitude <= 8);
            secp256k1_fe_verify(a);
        ...
        public static void secp256k1_fe_cmov(secp256k1_fe r, secp256k1_fe a, bool flag)
        {
            secp256k1_fe_cmov(r, a, (UInt32)(flag ? 1 : 0));
        }

        public static void secp256k1_fe_cmov(secp256k1_fe r, secp256k1_fe a, UInt32 flag)
        {
            UInt32 mask0, mask1;
            mask0 = flag + ~((UInt32)0);
            mask1 = ~mask0;
        ...
        public static void secp256k1_fe_storage_cmov(secp256k1_fe_storage r, secp256k1_fe_storage a, bool flag)
        {
            UInt32 mask0, mask1;
            mask0 = ~((UInt32)0);
            if (flag)
        ...
        public static void secp256k1_fe_to_storage(secp256k1_fe_storage r, secp256k1_fe a)
        {
#if VERIFY
        Util.VERIFY_CHECK(a.normalized);
#endif
        ...
        /// </summary>
        public static void secp256k1_fe_from_storage(secp256k1_fe r, secp256k1_fe_storage a)
        {
